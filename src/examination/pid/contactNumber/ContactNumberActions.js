...
export const getAllContactNumberAction = () => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`${API_URL}/api/PID_ContactNumber/GetAllPIDContactNumber`,tokenConfig)
  ...
  export const updateSingleContactNumberAction = (contactNumber) => async (dispatch) => {
    try {
