...
export const getAllJobHistoryAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${API_URL}/api/PID_JobHistory/GetAllPIDJobHistiory`,tokenConfig
    );
...
export const createSingleJobHistoryAction = (jobHistory) => async (dispatch) => {
  try {
...
export const jobHistoryCreateAction = (jobHistoryCreate) => async (dispatch) => {
  try {
